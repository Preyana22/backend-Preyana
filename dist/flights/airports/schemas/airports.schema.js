...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], Airport.prototype, "iata_country_code", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], Airport.prototype, "iata_city_code", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], Airport.prototype, "city_name", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", Number)
], Airport.prototype, "longitude", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], Airport.prototype, "airport_id", void 0);
Airport = __decorate([
    (0, mongoose_1.Schema)()
], Airport);
exports.Airport = Airport;
exports.AirportSchema = mongoose_1.SchemaFactory.createForClass(Airport);
//# sourceMappingURL=airports.schema.js.map
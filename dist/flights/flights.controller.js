...
let PostsController = class PostsController {
  ...
  async airliness(req) {
    ...
    let test =
      offers_clientkey === null || offers_clientkey === void 0
        ? void 0
        : offers_clientkey.client_key;
...
__decorate(
  [
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [
      paginationParams_1.PaginationParams,
      String,
    ]),
    __metadata("design:returntype", Promise),
  ],
...
PostsController = __decorate(
  [
    ...
    (0, common_1.UseInterceptors)(
      (0, mongooseClassSerializer_interceptor_1.default)(flights_schema_1.Post)
    ),

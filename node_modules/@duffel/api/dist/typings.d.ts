...
declare module '@duffel/api' {
    ...
    import { Cards } from '@duffel/api/Vault/Cards';
...
declare module '@duffel/api/Vault/Cards' {
    export * from '@duffel/api/Vault/Cards/Cards';
}
...
declare module '@duffel/api/Vault/Cards/Cards' {
    import { Client } from '@duffel/api/Client';
    import { Resource } from '@duffel/api/Resource';
    import { DuffelResponse } from '@duffel/api/types';
